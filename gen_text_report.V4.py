...
def add_table(t_doc: Document, t_raw_df: pd.DataFrame, t_table_config: dict, t_table_indent: int = -1000) -> int:
...
add_table(t_doc=report, t_raw_df=commodity_pos_df, t_table_config=table_config)
...
paragraph_count += 1
report.paragraphs[paragraph_count].paragraph_format.first_line_indent = Pt(norm_font_size * 2)
add_table(t_doc=report, t_raw_df=equity_pos_df, t_table_config=table_config)
